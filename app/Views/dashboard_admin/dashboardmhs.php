        ...
        <div class="p-1 active-cont">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center border-bottom" style="overflow: hidden;">
                <div class="row">
                    <div class="col-xl-3 col-lg-6 mb-2">
                        <div class="card card-stats mb-2 mb-xl-0 bg-success">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuausermhsterdaftar; ?></h5>
                                        <p class="card-text">Total Semua User Mahasiswa yang Ada Kartu</p>
                                        </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-3 col-lg-6 mb-2">
                        <div class="card card-stats mb-2 mb-xl-0 bg-info">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuausermhskeluar; ?></h5>
                                        <p class="card-text">Total User Mahasiswa yang Keluar Hari Ini</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 mb-2">
                        <div class="card card-stats mb-2 mb-xl-0 bg-warning">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuausermhsmasuk; ?></h5>
                    ...
                    <div class="col-xl-3 col-lg-6 mb-2" onClick="location.href='/admin/users/belumadakartu'">
                        <div class="card card-stats mb-2 mb-xl-0 bg-danger">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $usermhsbelumterdaftar; ?></h5>
                                        <p class="card-text">Total User Mahasiswa yang Belum Ada Kartu</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                    ...
                    <form action="/admin/dashboard/mahasiswa" id="form1" method="post">
                    <?= csrf_field() ?>
                    <input
                            type="month"
                            ...
                            <table class="table text-nowrap table-striped table-bordered mb-0 kv-grid-table kv-table-wrap" style="width: 140%">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-col-seq="5" style="width: 13.81%">
                                            Ruangan
                                        </th>
                                    ...
                                    <form action="/admin/dashboard/mahasiswa" method="post">
                                        <?= csrf_field() ?>
                                        <td>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                name="nim"
                                                value="<?= $inputnim; ?>"
                                                pattern=".{3,}" title="Cari NIM Minimal 3 Karakter"
                                            />
                                        </td>
                                        <td>
                                            <input
                                        ...
                                        <td>
                                            <select class="form-control" name="status_aktivitas" onchange='this.form.submit()'>
                                ...
                                <tbody>
                                    ...
                                    <tr class="w0" data-key="260481">
                                        ...
                                        <td class="w0" data-col-seq="4">
                                            <?= str_replace($inputruangan,'<span style="color: red;">' . $inputruangan . '</span>',$dt['room_access']); ?>
                                        </td>
                                        <td class="w0" data-col-seq="6"><?= str_replace($inputstatus_aktivitas,'<span style="color: red;">' . $inputstatus_aktivitas . '</span>',$dt['status_aktivitas']); ?></td>
                                        <td>
                                            <button
                                                type="button"
