...
<?php $this->section('container') ?>
        ...
        <div class="p-1 active-cont">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center border-bottom" style="overflow: hidden;">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card card-stats mb-2 mb-xl-0 bg-info">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuausermahasiswa; ?></h5>
                                        <p class="card-text">Total Semua Mahasiswa</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card card-stats mb-2 mb-xl-0 bg-danger">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuausermahasiswadeleted; ?></h5>
                                        <p class="card-text">Total Mahasiswa Deleted</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 mb-2">
                        <div class="card card-stats mb-2 mb-xl-0 bg-primary">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuausermahasiswaaktif; ?></h5>
                                        <p class="card-text">Total Mahasiswa Active</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                ...
                <?php elseif(session()->getFlashdata('uploadfotogagal')) : ?>
                    <div class="alert alert-warning" role="alert">
                        <?= session()->getFlashdata('uploadfotogagal'); ?>
                    </div>
                <?php endif; ?>
                <div class="btn-toolbar mb-md-0">
                    <div class="btn-group me-2">
                        <button type="submit" class="btn btn-primary mb-2" onclick="location.href=`/admin/tambah_user/mahasiswa`;">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/admin/users/upload_foto/mahasiswa" enctype="multipart/form-data" id="form1" method="post">
                                        <div class="modal-body">
                                                <?= csrf_field() ?>
                                                <div class="mb-3">
                                                    <label for="exampleDataList" class="form-label">Enter Username / NIM / Email</label>
                                                    <input class="form-control" list="datalistOptions" name="user" placeholder="Type to search..." required autofocus>
                                                    <datalist id="datalistOptions">
                                                        ...
                                                        <?php foreach ($data_users as $dt) : ?>
                                                            ...
                                                            <?php if($i > 5) : ?>
                                                                <?php break; ?>
                                                            <?php endif; ?>
                                                            <option value="<?= $dt['username']; ?> / <?= $dt['nim']; ?> / <?= $dt['email']; ?>">
                                                                <?= $dt['username']; ?> / <?= $dt['nim']; ?> / <?= $dt['email']; ?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </datalist>
                                                </div>
                                                ...
                                                <p class="text-danger">File Gambar Maksimal 512 KB Dengan Extensi JPG, JPEG atau PNG</p>
                ...
                <form action="/admin/users/mahasiswa" id="form1" method="post">
                <?= csrf_field() ?>
                <input
                        type="month"
                            ...
                            <thead>
                                ...
                                <td>
                                    <input
                                        ...
                                        name="nim"
                                        value="<?= $inputnim; ?>"
                                        pattern=".{2,}" title="Cari NIM Minimal 2 Karakter"
                                    />
                                </td>
                                <td>
                                    <input
                            ...
                            <tbody>
                                ...
                                <tr class="w0" data-key="260481">
                                    ...
                                    <td class="w0" data-col-seq="1">
                                        <?= str_replace($inputnim,'<span style="color: red;">' . $inputnim . '</span>',$dt['nim']); ?>
                                    </td>
                                    <td class="w0" data-col-seq="1">
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="exampleModal<?= $dt['nim']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="/admin/users/edit/mahasiswa" method="post" id="dtform">
                                                    <?= csrf_field() ?>
                                                        ...
                                                        <div class="modal-body">
                                                                ...
                                                                <input type="file" class="form-control" name="gambar" value="gambar" id="gambar" aria-label="file example">
                                            ...
                                            onclick="(function(){
                                                swal({
                                                    ...
                                                    if (willDelete) {
                                                        ...
                                                        if (okay) {
                                                            window.location.href = '/admin/users/delete/mahasiswa/<?= $dt['username']; ?>';
                                                        }
                                                    });
                                                    } else {
                                                ...
                                                onclick="(function(){
                                                    swal({
                                                        ...
                                                        if (willDelete) {
                                                            ...
                                                            if (okay) {
                                                                window.location.href = '/admin/users/active/mahasiswa/<?= $dt['username']; ?>';
                                                            }
                                                        });
                                                        } else {
