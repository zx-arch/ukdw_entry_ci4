            ...
            >
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card card-stats mb-2 mb-xl-0 bg-info">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuauserstaff; ?></h5>
                                        <p class="card-text">Total Semua Staff</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card card-stats mb-2 mb-xl-0 bg-danger">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuauserstaffdeleted; ?></h5>
                                        <p class="card-text">Total Staff Deleted</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 mb-2">
                        <div class="card card-stats mb-2 mb-xl-0 bg-primary">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuauserstaffaktif; ?></h5>
                                        <p class="card-text">Total Staff Active</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                ...
                <div class="btn-toolbar mb-md-0">
                    <div class="btn-group me-2">
                        <button type="submit" class="btn btn-primary mb-2" onclick="location.href=`/admin/tambah_user/staff`;">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/admin/users/upload_foto/staff" enctype="multipart/form-data" id="form1" method="post">
                                        <div class="modal-body">
                                                <?= csrf_field() ?>
                                                <div class="mb-3">
                                                    <label for="exampleDataList" class="form-label">Enter Username /  NIP / NIK / Email</label>
                                                    ...
                                                    <?php $i=0; ?>
                                                        <?php foreach ($data_users as $dt) : ?>
                                                            ...
                                                            <?php if($i > 5) : ?>
                                                                <?php break; ?>
                                                            <?php endif; ?>
                                                            <option value="<?= $dt['username']; ?> / <?= $dt['nip']; ?> / <?= $dt['nik']; ?> / <?= $dt['email']; ?>">
                                                                <?= $dt['username']; ?> / <?= $dt['nip']; ?> / <?= $dt['nik']; ?> / <?= $dt['email']; ?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </datalist>
                                                </div>
                ...
                <form action="/admin/users/staff" id="form1" method="post">
                <?= csrf_field() ?>
                <input
                        type="month"
                            ...
                            <thead>
                                ...
                                <td>
                                    <input
                                        ...
                                        name="nip"
                                        value="<?= $inputnip; ?>"
                                        pattern=".{5,}" title="Cari Nip Minimal 5 Karakter"
                                    />
                                </td>
                                <td>
                                    <input
                                ...
                                <tr class="w0" data-key="260481">
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="exampleModal<?= $dt['nim']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="/admin/users/edit/mahasiswa" enctype="multipart/form-data" method="post" id="dtform">
                                                    <?= csrf_field() ?>
                                            ...
                                            onclick="(function(){
                                                swal({
                                                    ...
                                                    if (willDelete) {
                                                        ...
                                                        if (okay) {
                                                            window.location.href = '/admin/users/delete/staff/<?= $dt['username']; ?>';
                                                        }
                                                    });
                                                    } else {
                                                ...
                                                onclick="(function(){
                                                    swal({
                                                        ...
                                                        if (willDelete) {
                                                            ...
                                                            if (okay) {
                                                                window.location.href = '/admin/users/active/staff/<?= $dt['username']; ?>';
                                                            }
                                                        });
                                                        } else {
