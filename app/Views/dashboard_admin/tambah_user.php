...
<div class="p-1 active-cont" style="overflow: hidden;">
    ...
    <form action="<?= base_url(); ?>/admin/tambah_user" class="user" method="post" enctype="multipart/form-data">
    <?= csrf_field() ?>
        ...
        <div class="col-sm-2 mb-3">
            <input type="text" name="nim" class="form-control form-control-user" placeholder="Masukkan NIM" value="<?= old('nim') ?>">
        </div>
        <div class="col-sm-2 mb-3">
        ...
        <div class="col-sm-2 mb-3">
            <input type="text" name="nidn" class="form-control form-control-user" placeholder="Masukkan NIDN" value="<?= old('nidn') ?>">
        </div>
        ...
        <div class="col-sm-2 mb-3">
            <select name="tipe_user" class="form-select" required aria-label="Default select example">
