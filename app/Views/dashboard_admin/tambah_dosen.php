...
<div class="p-1 active-cont" style="overflow: hidden;">
    ...
    <form action="<?= base_url(); ?>/admin/tambah_user/dosen" class="user" method="post" enctype="multipart/form-data">
    <?= csrf_field() ?>
        ...
        <input type="hidden" name="tipe_user" value="Dosen">
        <input type="hidden" name="idCardUser"value="dsn-">
    </div>
