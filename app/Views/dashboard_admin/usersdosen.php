            ...
            >
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card card-stats mb-2 mb-xl-0 bg-info">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuauserdosen; ?></h5>
                                        <p class="card-text">Total Semua Dosen</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card card-stats mb-2 mb-xl-0 bg-danger">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuauserdosendeleted; ?></h5>
                                        <p class="card-text">Total Dosen Deleted</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 mb-2">
                        <div class="card card-stats mb-2 mb-xl-0 bg-primary">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuauserdosenaktif; ?></h5>
                                        <p class="card-text">Total Dosen Active</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                ...
                <div class="btn-toolbar mb-md-0">
                    <div class="btn-group me-2">
                        <button type="submit" class="btn btn-primary mb-2" onclick="location.href=`/admin/tambah_user/dosen`;">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/admin/users/upload_foto/dosen"  id="form1" enctype="multipart/form-data" method="post">
                                        <div class="modal-body">
                                                <?= csrf_field() ?>
                                                <div class="mb-3">

                                                    <label for="exampleDataList" class="form-label">Enter Username /  NIP / NIDN / Email</label>
                                                    <input class="form-control" list="datalistOptions" name="user" id="form1" placeholder="Type to search...">
                                                    ...
                                                    <?php $i=0; ?>
                                                        <?php foreach ($data_users as $dt) : ?>
                                                            ...
                                                            <?php if($i > 5) : ?>
                                                                <?php break; ?>
                                                            <?php endif; ?>
                                                            <option value="<?= $dt['username']; ?> / <?= $dt['nip']; ?> / <?= $dt['nidn']; ?> / <?= $dt['email']; ?>">
                                                                <?= $dt['username']; ?> / <?= $dt['nip']; ?> / <?= $dt['nidn']; ?> / <?= $dt['email']; ?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </datalist>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" name="gambar" id="gambar" type="file" id="gambar">
                                                </div>
                                        </div>
                ...
                <form action="/admin/users/dosen" id="form1" method="post">
                <?= csrf_field() ?>
                <input
                        type="month"
                            ...
                            <thead>
                                ...
                                <td>
                                    <input
                                        ...
                                        name="nip"
                                        value="<?= $inputnip; ?>"
                                        pattern=".{3,}" title="Cari NIP Minimal 3 Karakter"
                                    />
                                </td>
                                <td>
                                    <input
                                        ...
                                        name="nidn"
                                        value="<?= $inputnidn; ?>"
                                        pattern=".{3,}" title="Cari NIDN Minimal 3 Karakter"
                                    />
                                </td>
                                <td>
                                    <input
                            ...
                            <tbody>
                                ...
                                <tr class="w0" data-key="260481">
                                    ...
                                    <td class="w0" data-col-seq="1">
                                        <?= str_replace($inputnip,'<span style="color: red;">' . $inputnip . '</span>',$dt['nip']); ?>
                                    </td>
                                    <td class="w0" data-col-seq="1">
                                        <?= str_replace($inputnidn,'<span style="color: red;">' . $inputnidn . '</span>',$dt['nidn']); ?>
                                    </td>
                                    <td class="w0" data-col-seq="1">
                                    ...
                                    <td>
                                        <button
                                            ...
                                            data-bs-toggle="modal" data-bs-target="#exampleModal<?= $dt['nip']; ?>"
                                        >
                                        <i class='bx bx-detail'></i>
                                        </button>
                                        <div class="modal fade" id="exampleModal<?= $dt['nip']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="/admin/users/edit/dosen" method="post" id="dtform">
                                                    <?= csrf_field() ?>
                                                        ...
                                                        <div class="modal-body">
                                                                ...
                                                                <div class="input-group flex-nowrap mb-2">
                                                                    <span class="input-group-text" id="addon-wrapping">NIP</span>
                                                                    <input type="text" class="form-control"
                                                                    name="nip"
                                                                    value="<?= $dt['nip']; ?>"
                                                                    aria-label="nip" aria-describedby="addon-wrapping">
                                                                </div>
                                                                <div class="input-group flex-nowrap mb-2">
                                                                    ...
                                                                    name="nidn"
                                                                    value="<?= $dt['nidn']; ?>"
                                                                    aria-label="nidn" aria-describedby="addon-wrapping">
                                                                </div>
                                                                <div class="input-group flex-nowrap mb-2">
                                            ...
                                            onclick="(function(){
                                                swal({
                                                    ...
                                                    if (willDelete) {
                                                        ...
                                                        if (okay) {
                                                            window.location.href = '/admin/users/delete/dosen/<?= $dt['username']; ?>';
                                                        }
                                                    });
                                                    } else {
                                                ...
                                                onclick="(function(){
                                                    swal({
                                                        ...
                                                        if (willDelete) {
                                                            ...
                                                            if (okay) {
                                                                window.location.href = '/admin/users/active/dosen/<?= $dt['username']; ?>';
                                                            }
                                                        });
                                                        } else {
