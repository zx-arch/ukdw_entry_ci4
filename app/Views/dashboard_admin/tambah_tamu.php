...
<div class="p-1 active-cont" style="overflow: hidden;">
    ...
    <form action="<?= base_url(); ?>/admin/tambah_user/tamu" class="user" method="post" enctype="multipart/form-data">
    <?= csrf_field() ?>
        ...
        <input type="hidden" name="tipe_user" value="Tamu">
        <input type="hidden" name="idCardUser"value="tm-">
    </div>
