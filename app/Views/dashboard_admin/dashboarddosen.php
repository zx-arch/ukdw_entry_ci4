        ...
        <div class="p-1 active-cont">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center border-bottom" style="overflow: hidden;">
                <div class="row">
                    <div class="col-xl-3 col-lg-6 mb-2">
                        <div class="card card-stats mb-2 mb-xl-0 bg-success">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuadosenterdaftar; ?></h5>
                                        <p class="card-text">Total Semua User Dosen yang Ada Kartu</p>
                                        </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-3 col-lg-6 mb-2">
                        <div class="card card-stats mb-2 mb-xl-0 bg-info">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuadosenkeluar; ?></h5>
                                        <p class="card-text">Total User Dosen Keluar Hari Ini</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 mb-2">
                        <div class="card card-stats mb-2 mb-xl-0 bg-warning">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuadosenmasuk; ?></h5>
                                        <p class="card-text">Total User Dosen Masuk Hari Ini</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 mb-2">
                        <div class="card card-stats mb-2 mb-xl-0 bg-danger">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $userdosenbelumterdaftar; ?></h5>
                                        <p class="card-text">Total User Dosen yang Belum Ada Kartu</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                    ...
                    <form action="/admin/dashboard/dosen" id="form1" method="post">
                    <?= csrf_field() ?>
                        <input
                            type="month"
                        ...
                        <div id="w0-container" class="table-responsive kv-grid-container">
                            <table class="table text-nowrap table-striped table-bordered mb-0 kv-grid-table kv-table-wrap" style="width: 140%">
                                <thead>
                                    ...
                                    <form action="/admin/dashboard/dosen" method="post">
                                        <?= csrf_field() ?>
                                        <td>
                                        </td>
                                        <td>
