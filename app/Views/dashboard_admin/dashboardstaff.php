        ...
        <div class="p-1 active-cont">
            ...
            >
                <div class="row">
                    <div class="col-xl-3 col-lg-6 mb-2">
                        <div class="card card-stats mb-2 mb-xl-0 bg-success">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuastaffterdaftar; ?></h5>
                                        <p class="card-text">Total Semua User Staff yang Ada Kartu</p>
                                        </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-3 col-lg-6 mb-2">
                        <div class="card card-stats mb-2 mb-xl-0 bg-info">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuastaffkeluar; ?></h5>
                                        <p class="card-text">Total User Staff yang Keluar Hari Ini</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 mb-2">
                        <div class="card card-stats mb-2 mb-xl-0 bg-warning">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $semuastaffmasuk; ?></h5>
                                        <p class="card-text">Total User Staff yang Masuk Hari Ini</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 mb-2">
                        <div class="card card-stats mb-2 mb-xl-0 bg-danger">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title"><?= $userstaffbelumterdaftar; ?></h5>
                                        <p class="card-text">Total User Staff yang Belum Ada Kartu</p>
                                        </div>
                                    <div class="col-auto">
                                        <div class="icon icon-shape bg-yellow text-white rounded-circle shadow">
                                            <i class="fas fa-users"></i>
                    ...
                    <form action="/admin/dashboard/staff" id="form1" method="post">
                    <?= csrf_field() ?>
                    <input
                            type="month"
                        ...
                        <div id="w0-container" class="table-responsive kv-grid-container">
                            <table class="table text-nowrap table-striped table-bordered mb-0 kv-grid-table kv-table-wrap" style="width: 140%">
                                <thead>
                                    ...
                                    <form action="admin/dashboard/staff" method="post">
                                        <?= csrf_field() ?>
                                        <td>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                name="nik"
                                                value="<?= $inputnik; ?>"
                                                pattern=".{3,}" title="Cari NIK Card Minimal 3 Karakter"
                                            />
                                        </td>
                                        <td>
                                            <input
                                                ...
                                                name="nip"
                                                value="<?= $inputnip; ?>"
                                                pattern=".{3,}" title="Cari NIP Card Minimal 3 Karakter"
                                            />
                                        </td>
                                        <td>
                                            <input
