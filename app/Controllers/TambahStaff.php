...
class TambahStaff extends BaseController
{
    ...
    public function index()
    {
        if ($this->request->getPost() == null) {
            return view('dashboard_admin/tambah_staff',["title" => "Tambah User",'config' => $this->config]);
        } else {
            ...
            $dataaddprofil = [
                'idCardUser' => $this->request->getPost('idCardUser').$this->request->getPost('nip'),
